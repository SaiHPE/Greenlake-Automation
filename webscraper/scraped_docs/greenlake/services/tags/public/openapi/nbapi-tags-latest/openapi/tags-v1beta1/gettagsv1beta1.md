---
title: "GET /tags/v1beta1/tags"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/tags/public/openapi/nbapi-tags-latest/openapi/tags-v1beta1/gettagsv1beta1.md"
scraped_at: "2026-06-07T06:16:27.113106+00:00Z"
---
...
Endpoint: GET /tags/v1beta1/tags
Version: v1
Security: Bearer
...
The examples are not an exhaustive list of all possible filtering options.
  ...
  - `sort` (string)
    A comma separated list of sort expressions. A sort expression is a property name optionally followed by a direction indicator asc or desc. If no direction is provided, the ascending (asc) order is followed by default. If no sort expressions are specified for this query parameter, the response will be sorted by the createdAt timestamp in descending order. type and resourceCount are not supported for sorting.
