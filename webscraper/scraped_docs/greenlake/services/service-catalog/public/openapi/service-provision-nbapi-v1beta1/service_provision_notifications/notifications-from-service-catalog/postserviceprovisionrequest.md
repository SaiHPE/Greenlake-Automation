---
title: "POST /broker-uri/provision-request"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/service-catalog/public/openapi/service-provision-nbapi-v1beta1/service_provision_notifications/notifications-from-service-catalog/postserviceprovisionrequest.md"
scraped_at: "2026-06-07T06:15:42.976135+00:00Z"
---
...
Endpoint: POST /broker-uri/provision-request
Version: v1beta1
Security: bearerAuth
...
## Header parameters:
  ...
  - `Hpe-Workspace-Id` (string)
    Workspace-id of the logged-in user. Needed only if the token doesn't contain it.
    Example: "8fa85f64-5717-4562-b3fc-2c963f66afa3"

  - `Hpe-User-Id` (integer)
    Id of the logged-in user. Needed only if the token doesn't contain it.
...
## Request fields (application/json):
  ...
  - `serviceProvisionId` (string, required)
