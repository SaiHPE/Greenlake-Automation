---
title: "POST /service-catalog/v1beta1/service-provisions"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/service-catalog/public/openapi/service-provision-nbapi-v1beta1/service_provision_v1beta1_nbapi/service-provision/postserviceprovision.md"
scraped_at: "2026-06-07T06:15:46.443599+00:00Z"
---

# Create a service provision

The initial step to provision a service offer in a region. A service offer provides a distinct set of functionalities that can be independently identified and assigned access. Service offers are typically associated with roles and permissions, commerce, metering, quote-to-cash, and trial evaluations.You need to supply the following in the request body. serviceOfferId-From Service offer management use the Get service offers endpoint to find service offer IDs.region-From Service offer management use the Get service offer regions endpoint to find region codes.

Endpoint: POST /service-catalog/v1beta1/service-provisions
Version: v1beta1
Security: bearerAuth
