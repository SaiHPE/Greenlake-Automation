---
title: "GET /service-catalog/v1beta1/recent-services"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/service-catalog/public/openapi/service-registry-v1beta1/service_catalog_v1beta1_nbapi/ui-management/getrecentservices.md"
scraped_at: "2026-06-07T06:15:50.750044+00:00Z"
---
...
Endpoint: GET /service-catalog/v1beta1/recent-services
Version: v1beta1
Security: bearerAuth
...
## Response 200 fields (application/json):
  ...
  - `items.serviceOffer.workspaceTypes` (array, required)
    Workspace Types supported
    Enum: "BASIC_ORGANIZATION", "STANDALONE", "MSP", "TENANT"

  - `items.serviceOffer.workspaceOpModes` (array, required)
    Types of Workspace Operational Modes for Tenant Workspaces
    Enum: "CUSTOMER_OWNED_INVENTORY", "MSP_OWNED_INVENTORY", "ALL", "NONE"

  - `items.lastAccessedTime` (string)
    Most recent date and time at which service offer was launched
    Example: "2021-04-23T10:20:30.400+02:30"

  - `items.regionalProvisions` (array)

  - `items.regionalProvisions.id` (string)
    Region as provision identifier
    Example: "us-east"

  - `items.regionalProvisions.serviceManagerProvision` (object)
    Service manager provision details

  - `items.regionalProvisions.serviceManagerProvision.id` (string, required)
    Example: "2fa85f6457174562b3fc2c963f66afa1"

  - `items.regionalProvisions.serviceManagerProvision.resourceUri` (string, required)
  ...
  - `items.regionalProvisions.serviceManagerProvision.serviceManager` (object, required)

  - `items.regionalProvisions.serviceManagerProvision.serviceManager.id` (string)
    The unique identifier for the service manager.
    Example: "7267b0e0-013c-4181-8c27-01b395ed0b61"

  - `items.regionalProvisions.serviceManagerProvision.serviceManager.resourceUri` (string)
  ...
  - `items.regionalProvisions.serviceManagerProvision.region` (string, required)
    Example: "us-east"

  - `items.regionalProvisions.serviceManagerProvision.provisionStatus` (string, required)
  ...
  - `items.regionalProvisions.serviceManagerProvision.serviceManagerInstanceId` (string, required)
    Example: "3fa85f64-5717-4562-b3fc-2c963f66afa6"

  - `items.regionalProvisions.serviceManagerProvision.createdAt` (string, required)
    Date and time at which the service offer was created or upgraded.
    Example: "2021-04-23T10:20:30.400+02:30"

  - `items.regionalProvisions.serviceManagerProvision.updatedAt` (string, required)
    Date and time at which the service offer was updated.
    Example: "2021-04-29T10:20:30.400+02:30"

  - `items.regionalProvisions.serviceManagerProvision.generation` (integer, required)
    Monotonically increasing update counter.
    Example: 1

  - `items.regionalProvisions.serviceManagerProvision.reason` (string, required)
    Reason for failure
    Example: "Failed to configure IDP."

  - `items.regionalProvisions.serviceManagerProvision.workspaceTransferStatus` (string)
  ...
  - `items.regionalProvisions.serviceProvision` (object)

  - `items.regionalProvisions.serviceProvision.id` (string, required)
    Service provision identifier
    Example: "2fa85f64-5717-4562-b3fc-2c963f66afa9"

  - `items.regionalProvisions.serviceProvision.resourceUri` (string, required)
    Example: "/service-catalog/v1beta1/service-provisions/2fa85f64-5717-4562-b3fc-2c963f66afa9"

  - `items.regionalProvisions.serviceProvision.serviceOffer` (object, required)

  - `items.regionalProvisions.serviceProvision.serviceOffer.id` (string)
    The unique identifier for the service offer.
    Example: "4ab85f64-5717-4562-b3fc-2c963f66afa6"

  - `items.regionalProvisions.serviceProvision.serviceOffer.resourceUri` (string)
  ...
  - `items.regionalProvisions.serviceProvision.workspace` (object, required)

  - `items.regionalProvisions.serviceProvision.workspace.id` (string)
    The unique identifier for the workspace.
    Example: "4ab85f64-5717-4562-b3fc-2c963f66afa6"

  - `items.regionalProvisions.serviceProvision.workspace.resourceUri` (string)
    The URI reference to this resource.
    Example: "/workspaces/v1/workspaces/4ab85f64-5717-4562-b3fc-2c963f66afa6"

  - `items.regionalProvisions.serviceProvision.workspace.name` (string)
    The display name of the workspace.
    Example: "Hewlett Packard Enterprise"

  - `items.regionalProvisions.serviceProvision.workspace.organizationId` (string)
    The unique identifier of the organization.
    Example: "5ab85f64-6717-5562-c3fc-3c963f66afa6"

  - `items.regionalProvisions.serviceProvision.generation` (integer, required)
    Generated/updated version
    Example: 1

  - `items.regionalProvisions.serviceProvision.serviceManagerProvision` (object)

  - `items.regionalProvisions.serviceProvision.serviceManagerProvision.id` (string)
    The unique identifier for the service manager provision.
    Example: "2fb85f6457174562b3fc2c963f66afa2"

  - `items.regionalProvisions.serviceProvision.serviceManagerProvision.resourceUri` (string)
    The URI reference to the service manager provision resource.
    Example: "/service-catalog/v1beta1/service-manager-provisions/2fb85f64-5717-4562-b3fc-2c963f66afa2"

  - `items.regionalProvisions.serviceProvision.reason` (string)
    Example: "Failed to configure IDP."

  - `items.regionalProvisions.serviceProvision.createdBy` (string)
