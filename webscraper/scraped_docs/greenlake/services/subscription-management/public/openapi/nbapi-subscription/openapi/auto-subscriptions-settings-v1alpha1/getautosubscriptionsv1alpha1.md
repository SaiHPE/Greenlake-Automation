---
title: "GET /subscriptions/v1alpha1/auto-subscription-settings"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/subscription-management/public/openapi/nbapi-subscription/openapi/auto-subscriptions-settings-v1alpha1/getautosubscriptionsv1alpha1.md"
scraped_at: "2026-06-07T06:16:24.857325+00:00Z"
---

# Get all configured auto-subscriptions settings (deprecated)

Get all configured auto-subscriptions settings in a workspace.  NOTE: You need to have the view permission for the Devices and subscription service to invoke this API.  Rate limits are enforced on this API. 25 requests per minute is supported per workspace. API will result in 429 if this threshold is breached.

Endpoint: GET /subscriptions/v1alpha1/auto-subscription-settings
Version: latest
Security: Bearer
