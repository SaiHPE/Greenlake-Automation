---
title: "GET /compute-ops-mgmt/v1/settings/{id}"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/compute-ops-mgmt/public/openapi/compute-ops-mgmt-remote/openapi/settings-v1/get_v1_settings_by_id.md"
scraped_at: "2026-06-07T06:14:50.860607+00:00Z"
---

# Get a device setting by ID

Get a specific device settings item by its id.

Endpoint: GET /compute-ops-mgmt/v1/settings/{id}
Version: latest
Security: Bearer
...
| OVE_SOFTWARE_SYNERGY           | OneView Synergy appliance software                   |
  ...
  - `resourceUri` (string)
    ...
    Example: "/compute-ops-mgmt/v1/settings/a2fdaf7a-4933-4c47-bfe0-891f0a83dc6e"
