---
title: "GET /compute-ops-mgmt/v1beta1/ahs-files/{id}"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/compute-ops-mgmt/public/openapi/compute-ops-mgmt-remote/openapi/ahs-files-v1beta1/get_ahs_file_parse_request_v1beta1_by_id.md"
scraped_at: "2026-06-07T06:14:40.634285+00:00Z"
---
...
Endpoint: GET /compute-ops-mgmt/v1beta1/ahs-files/{id}
Version: latest
Security: Bearer
...
## Response 200 fields (application/json):
  ...
  - `parsingResults.components.INVENTORY` (object)
    File name of the inventory details of the server.
