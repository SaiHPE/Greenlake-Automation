---
title: "PATCH /compute-ops-mgmt/v1beta2/approval-policies/{policy_id}"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/compute-ops-mgmt/public/openapi/compute-ops-mgmt-remote/openapi/approval-policy-v1beta2/patch_v1beta2_approval_policy_by_id.md"
scraped_at: "2026-06-07T06:14:41.592564+00:00Z"
---
...
Endpoint: PATCH /compute-ops-mgmt/v1beta2/approval-policies/{policy_id}
Version: latest
Security: Bearer
...
## Request fields (application/merge-patch+json):
  ...
  - `policyData` (object)
    Data for the policy containing information about approvers and resources
that are assigned to the policy. User can modify the approvables and 
resources assigned to the policy.
If the user wants to modify a policy assigned to a group resource,
then the user must specify the resource ID of the group in the resources array.
This is an optional parameter that can be used to update the policy data.
