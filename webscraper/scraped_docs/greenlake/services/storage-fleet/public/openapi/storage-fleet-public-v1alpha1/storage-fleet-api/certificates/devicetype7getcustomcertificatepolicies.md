---
title: "GET /storage-fleet/v1alpha1/devtype7-storage-systems/{systemId}/custom-certificate-policies"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/storage-fleet/public/openapi/storage-fleet-public-v1alpha1/storage-fleet-api/certificates/devicetype7getcustomcertificatepolicies.md"
scraped_at: "2026-06-07T06:16:07.455489+00:00Z"
---
...
Endpoint: GET /storage-fleet/v1alpha1/devtype7-storage-systems/{systemId}/custom-certificate-policies
Version: 1.2.0
Security: bearer
...
## Response 200 fields (application/json):
  ...
  - `items.status.certificate.subjectAltNames` (string,null)
  ...
  - `items.status.certificateType` (string,null)
    The Custom Certificate Type of the resource.
    Example: "S3"

  - `items.status.customCertificateRef` (string,null)
    The name of the currently active CustomCertificate. Filter, Sort
    Example: "S3-default-certificate-0"

  - `items.status.instance` (string,null)
    The instance label
    Example: "default"

  - `items.status.key` (object,null)
    Specification of the type of key to generate.

  - `items.status.key.ecdsa` (object,null)
    Specification of the type of key to generate.

  - `items.status.key.ecdsa.curve` (string,null)
    The key curve for the generated key. Only valid if spec.key.type is "ECDSA".
    Example: "P-384"

  - `items.status.key.rsa` (object,null)
    Specification of the type of key to generate.

  - `items.status.key.rsa.size` (integer,null)
    The key size for the generated key pair. Only valid if spec.key.type is "RSA".
    Example: 3027

  - `items.status.key.type` (string,null)
  ...
  - `items.status.renewPercentage` (integer,null)
    Renew Percentage
    Example: 25
