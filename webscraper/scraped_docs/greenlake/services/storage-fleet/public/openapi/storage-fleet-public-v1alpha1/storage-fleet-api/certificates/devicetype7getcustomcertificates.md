---
title: "GET /storage-fleet/v1alpha1/devtype7-storage-systems/{systemId}/custom-certificates"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/storage-fleet/public/openapi/storage-fleet-public-v1alpha1/storage-fleet-api/certificates/devicetype7getcustomcertificates.md"
scraped_at: "2026-06-07T06:16:07.483467+00:00Z"
---
...
Endpoint: GET /storage-fleet/v1alpha1/devtype7-storage-systems/{systemId}/custom-certificates
Version: 1.2.0
Security: bearer
...
## Response 200 fields (application/json):
  ...
  - `items.status` (object,null)
    The current status of the Custom Certificate.

  - `items.status.caCertificate` (string,null)
  ...
  - `items.status.certificate.subjectAltNames` (object,null)
    SAN lists the Subject Alternative Name values.

  - `items.status.certificate.subjectAltNames.dnsNames` (array,null)
    DNS names included in the certificate SAN.
    Example: ["hfsim-s3-cluster.hfsim.nimblestorage.com"]
  ...
  - `items.status.certificateSigningRequest` (string,null)
    It is the CSR.

  - `items.status.customCertificatePolicyRef` (string,null)
    Name of the associated Custom Certificate Policy. Filter, Sort
  ...
  - `items.status.subject` (string,null)
    The distinguished names being used in LDAP
    Example: "CN=S3,DC=corp,DC=company,DC=COM"
