---
title: "GET /storage-fleet/v1alpha1/devtype7-storage-systems/{systemId}/custom-certificate-policies/{certificatePolicyId}"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/storage-fleet/public/openapi/storage-fleet-public-v1alpha1/storage-fleet-api/certificates/devicetype7getcustomcertificatepoliciesbyid.md"
scraped_at: "2026-06-07T06:16:07.429189+00:00Z"
---
...
Endpoint: GET /storage-fleet/v1alpha1/devtype7-storage-systems/{systemId}/custom-certificate-policies/{certificatePolicyId}
Version: 1.2.0
Security: bearer
...
## Path parameters:
  ...
  - `certificatePolicyId` (string, required)
...
## Response 200 fields (application/json):
  ...
  - `status.certificate.subjectAltNames` (string,null)
  ...
  - `status.certificateType` (string,null)
    The Custom Certificate Type of the resource.
    Example: "S3"

  - `status.customCertificateRef` (string,null)
    The name of the currently active CustomCertificate .
    Example: "S3-default-certificate-0"

  - `status.instance` (string,null)
    The instance label
    Example: "default"

  - `status.key` (object,null)
    Specification of the type of key to generate.

  - `status.key.ecdsa` (object,null)
    Specification of the type of key to generate.

  - `status.key.ecdsa.curve` (string,null)
    The key curve for the generated key. Only valid if spec.key.type is "ECDSA".
    Example: "P-384"

  - `status.key.rsa` (object,null)
    Specification of the type of key to generate.

  - `status.key.rsa.size` (integer,null)
    The key size for the generated key pair. Only valid if spec.key.type is "RSA".
    Example: 3027

  - `status.key.type` (string,null)
    The key type for the generated key pair.
    Example: "RSA"
  ...
  - `status.renewPercentage` (integer,null)
    Renew Percentage
    Example: 25
