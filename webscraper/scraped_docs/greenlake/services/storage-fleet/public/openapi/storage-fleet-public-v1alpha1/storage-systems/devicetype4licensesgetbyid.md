---
title: "GET /storage-fleet/v1alpha1/devtype4-storage-systems/{systemId}/licenses"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/storage-fleet/public/openapi/storage-fleet-public-v1alpha1/storage-systems/devicetype4licensesgetbyid.md"
scraped_at: "2026-06-07T06:15:59.705129+00:00Z"
---
...
Endpoint: GET /storage-fleet/v1alpha1/devtype4-storage-systems/{systemId}/licenses
Version: 1.2.0
Security: bearer
...
## Response 200 fields (application/json):
  ...
  - `items.diskCount` (string,null)
    The disk count from the system license
    Example: "2"

  - `items.features` (object,null)
    The raw list of individual licensed features

  - `items.issueDate` (object,null)
    The date the system license was issued

  - `items.issueDate.ms` (integer,null)
    Epoch time in milliseconds
    Example: 1591601529000

  - `items.issueDate.tz` (string,null)
    Time zone name
    Example: "Local"
