---
title: "GET /storage-fleet/v1alpha1/devtype7-storage-systems/{systemId}/trust-stores"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/storage-fleet/public/openapi/storage-fleet-public-v1alpha1/storage-fleet-api/certificates/devicetype7gettruststores.md"
scraped_at: "2026-06-07T06:16:08.198876+00:00Z"
---
...
Endpoint: GET /storage-fleet/v1alpha1/devtype7-storage-systems/{systemId}/trust-stores
Version: 1.2.0
Security: bearer
...
## Response 200 fields (application/json):
  ...
  - `items.status.certificate` (array,null)
  ...
  - `items.status.certificateType` (string,null)
    The Custom Certificate Type of the Trust Store. Filter, Sort
    Example: "S3"

  - `items.status.instance` (string,null)
    The Trust Store instance label
    Example: "default"
  ...
  - `items.status.thumbprint` (string,null)
    Thumbprint of concatenated certificates.
