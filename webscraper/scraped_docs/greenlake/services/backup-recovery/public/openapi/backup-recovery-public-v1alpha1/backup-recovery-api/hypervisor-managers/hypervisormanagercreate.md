---
title: "POST /backup-recovery/v1alpha1/hypervisor-managers"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/backup-recovery/public/openapi/backup-recovery-public-v1alpha1/backup-recovery-api/hypervisor-managers/hypervisormanagercreate.md"
scraped_at: "2026-06-07T06:13:58.563452+00:00Z"
---
...
Endpoint: POST /backup-recovery/v1alpha1/hypervisor-managers
Version: 1.1.0
Security: bearer
...
## Request fields (application/json):
  ...
  - `hypervisorManagerType` (string, required)
    The type of the hypervisor manager. Currently only vCenter is supported.
    Enum: "VMWARE_VCENTER"

  - `dataOrchestratorId` (string, required)
