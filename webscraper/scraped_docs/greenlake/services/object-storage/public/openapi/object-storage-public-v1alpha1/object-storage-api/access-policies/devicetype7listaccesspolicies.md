---
title: "GET /object-storage/v1alpha1/devtype7-storage-systems/{systemId}/access-policies"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/object-storage/public/openapi/object-storage-public-v1alpha1/object-storage-api/access-policies/devicetype7listaccesspolicies.md"
scraped_at: "2026-06-07T06:15:31.496346+00:00Z"
---
...
Endpoint: GET /object-storage/v1alpha1/devtype7-storage-systems/{systemId}/access-policies
Version: 1.1.0
Security: bearer
...
## Response 200 fields (application/json):
  ...
  - `items.statement.action` (array)
    Specifies the action that is allowed or denied

  - `items.statement.condition` (object,null)

  - `items.statement.effect` (string)
    Specifies whether the statement results in an allow or deny

  - `items.statement.resource` (array,null)

  - `items.statement.sid` (string,null)
