---
title: "GET /private-cloud-business/v1beta1/systems/{id}"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/private-cloud-business/public/openapi/private-cloud-business-public-v1beta1/private-cloud-business-api/systems/getsysteminfo.md"
scraped_at: "2026-06-07T06:15:36.858971+00:00Z"
---

# Get information about the specified system subject to query parameters.

Returns the system properties specified in the query parameters. 
...
Endpoint: GET /private-cloud-business/v1beta1/systems/{id}
Version: 1.1.0
Security: bearer
...
Similarly, hypervisor clusters update status collection (property softwareInfo.hypervisorClusters) can be selected, but, selecting elements of the collection is not supported in the select query parameter.
    Example: "select=id,name,softwareInfo,computeUsage,associatedResourceCount\n"
