---
title: "GET /block-storage/v1alpha1/devtype4-storage-systems/{systemId}/volumes/{id}/performance-history"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/block-storage/public/openapi/block-storage-public-v1alpha1/volumes/devicetype4volumeperformancehistorygetbyid.md"
scraped_at: "2026-06-07T06:14:29.036700+00:00Z"
---
...
Endpoint: GET /block-storage/v1alpha1/devtype4-storage-systems/{systemId}/volumes/{id}/performance-history
Version: 1.0.0
Security: bearer
...
## Response 200 fields (application/json):
  ...
  - `items.historyData.iopsMetricsData` (object,null)
    Timeseries data for particular metric type

  - `items.historyData.iopsMetricsData.total` (integer,null)
    count of series data
    Example: 1

  - `items.historyData.ioszMetricsData` (object,null)
    Timeseries data for particular metric type

  - `items.historyData.latencyMetricsDataMs` (object,null)
    Timeseries data for particular metric type

  - `items.historyData.qlenMetricsData` (object,null)
    Timeseries data for particular metric type

  - `items.historyData.qlenMetricsData.total` (integer,null)
    total number of series data
    Example: 1

  - `items.historyData.throughputMetricsDataKbps` (object,null)
    Timeseries data for particular metric type
