---
title: "GET /virtualization/v1beta1/hypervisor-managers/{hypervisor-id}/networks/{network-id}"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/virtualization/public/openapi/virtualization-public-v1beta1/virtualization-api/hypervisor-networks/hypervisornetwork.md"
scraped_at: "2026-06-07T06:16:29.470442+00:00Z"
---

# Get a hypervisor network resource identified by {network-id}

Details of a hypervisors network resource.

Endpoint: GET /virtualization/v1beta1/hypervisor-managers/{hypervisor-id}/networks/{network-id}
Version: 1.2.0
Security: bearer
