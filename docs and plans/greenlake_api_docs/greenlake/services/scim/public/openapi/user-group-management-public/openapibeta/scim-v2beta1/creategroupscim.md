---
title: "POST /identity/v2beta1/scim/v2/Groups"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/scim/public/openapi/user-group-management-public/openapibeta/scim-v2beta1/creategroupscim.md"
scraped_at: "2026-06-07T06:15:35.972836+00:00Z"
---
...
Endpoint: POST /identity/v2beta1/scim/v2/Groups
Version: v2.0
Security: Bearer
...
Each URI represents a schema that determines which properties can be included and how they should be formatted.
  ...
  - `urn:ietf:params:scim:schemas:extensions:hpe-greenlake:2.0:Group` (object)
