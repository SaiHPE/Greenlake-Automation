---
title: "GET /storage-fleet/v1alpha1/devtype4-storage-systems/{systemId}/enclosures/{enclosureId}/enclosure-sleds"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/storage-fleet/public/openapi/storage-fleet-public-v1alpha1/storage-fleet-api/shelves/devicetype4enclosuresledslist.md"
scraped_at: "2026-06-07T06:16:12.181136+00:00Z"
---
...
Endpoint: GET /storage-fleet/v1alpha1/devtype4-storage-systems/{systemId}/enclosures/{enclosureId}/enclosure-sleds
Version: 1.2.0
Security: bearer
...
## Response 200 fields (application/json):
  ...
  - `items.okIndicator` (boolean,null)

  - `items.portBypassA` (boolean,null)

  - `items.portBypassB` (boolean,null)

  - `items.power` (boolean,null)

  - `items.predFailIndicator` (boolean,null)
  ...
  - `items.sledId` (integer,null)
    Numeric ID of the resource

  - `items.stateLoopA` (object,null)
    State of the resource

  - `items.stateLoopA.detailed` (array,null)
    Array of the detailed states of the resource

  - `items.stateLoopA.overall` (string,null)
