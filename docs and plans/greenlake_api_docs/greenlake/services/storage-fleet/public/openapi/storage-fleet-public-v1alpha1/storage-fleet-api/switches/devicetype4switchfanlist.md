---
title: "GET /storage-fleet/v1alpha1/devtype4-storage-systems/{systemId}/switches/{switchId}/switch-fans"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/storage-fleet/public/openapi/storage-fleet-public-v1alpha1/storage-fleet-api/switches/devicetype4switchfanlist.md"
scraped_at: "2026-06-07T06:16:14.802001+00:00Z"
---
...
Endpoint: GET /storage-fleet/v1alpha1/devtype4-storage-systems/{systemId}/switches/{switchId}/switch-fans
Version: 1.2.0
Security: bearer
...
## Response 200 fields (application/json):
  ...
  - `items.localizedSpeedA` (object,null)
    Switch fan localized speed

  - `items.localizedSpeedA.default` (string,null)
    default value of switch fan localized speed
    Example: "Normal"

  - `items.localizedSpeedA.key` (string,null)
    key of switch fan localized speed
    Example: "SWITCH_FAN_SPEED_NORMAL"

  - `items.localizedSpeedB` (object,null)
    Switch fan localized speed
  ...
  - `items.speedA` (string,null)
    Switch fan speed
    Example: "normal"

  - `items.speedB` (string,null)
    Switch fan speed
    Example: "normal"
  ...
  - `items.stateA` (object,null)
    State of the resource

  - `items.stateB` (object,null)
    State of the resource

  - `items.switchFanId` (integer,null)
    ID of the resource
    Example: 1
