---
title: "PUT /service-catalog/v1alpha1/service-offers/{id}"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/service-catalog/public/openapi/service-registry-v1beta1/v1alpha1/service_registry_v1alpha1_appapi/service-offers/updateserviceoffer.md"
scraped_at: "2026-06-07T06:16:43.433579+00:00Z"
---
...
Endpoint: PUT /service-catalog/v1alpha1/service-offers/{id}
Version: v1alpha1
Security: bearerAuth
...
## Request fields (application/json):
  ...
  - `is_service_manager` (boolean, required)
  ...
  - `languages_supported` (array)
    Languages supported for the service offer
    Example: ["en-US","es-ES"]

  - `features_supported` (array)
    Features supported
    Enum: "DEEP_LINKING", "SERVICE_PROVISIONING", "ORG_SINGLETON_SERVICE_PROVISIONING", "SKIP_SERVICE_MGR_PROVISIONING", "SKIP_SERVICE_UNPROVISIONING", "EVALUATION", "RBAC", "ORG_PARENT_SUPPORTED", "HONOR_UNPROVISION_RESPONSE"
