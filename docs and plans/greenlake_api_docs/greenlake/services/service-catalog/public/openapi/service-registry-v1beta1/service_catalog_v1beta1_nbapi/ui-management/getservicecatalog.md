---
title: "GET /service-catalog/v1beta1/service-catalog"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/service-catalog/public/openapi/service-registry-v1beta1/service_catalog_v1beta1_nbapi/ui-management/getservicecatalog.md"
scraped_at: "2026-06-07T06:15:50.577549+00:00Z"
---
...
Endpoint: GET /service-catalog/v1beta1/service-catalog
Version: v1beta1
Security: bearerAuth
...
## Response 200 fields (application/json):
  ...
  - `items.servicesWithRegions` (array, required)
  ...
  - `items.servicesWithRegions.serviceOffer.name` (string, required)
    The name of the service offer.
    Example: "Aruba Central"

  - `items.servicesWithRegions.serviceOffer.slug` (string, required)
    A short identifier for the service offer.
    Example: "AC"

  - `items.servicesWithRegions.serviceOffer.overview` (string, required)
  ...
  - `items.servicesWithRegions.serviceOffer.serviceOfferType` (string, required)
  ...
  - `items.servicesWithRegions.serviceOffer.featuresSupported` (array, required)
  ...
  - `items.servicesWithRegions.serviceOffer.brokerUri` (string, required)
  ...
  - `items.servicesWithRegions.serviceOffer.preProvisionMessage` (string, required)
  ...
  - `items.servicesWithRegions.availableRegions.type` (string)
  ...
  - `items.servicesWithRegions.type` (string)
