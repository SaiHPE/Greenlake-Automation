...
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/service-catalog/public/openapi/service-provision-nbapi-v1beta1/service_provision_v1beta1_appapi/service-provisions/getserviceprovisions.md"
scraped_at: "2026-06-07T06:15:44.828401+00:00Z"
---
...
## Header parameters:
  ...
  - `Hpe-workspace-id` (string)
    Is required for (only) App API if view all is false
