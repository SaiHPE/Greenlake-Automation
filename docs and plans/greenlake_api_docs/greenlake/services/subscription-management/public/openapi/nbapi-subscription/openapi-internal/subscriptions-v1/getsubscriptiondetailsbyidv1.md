---
title: "GET /subscriptions/v1/subscriptions/{id}"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/subscription-management/public/openapi/nbapi-subscription/openapi-internal/subscriptions-v1/getsubscriptiondetailsbyidv1.md"
scraped_at: "2026-06-07T06:15:52.802730+00:00Z"
---

# Get information on a subscription

Get detailed information for a single subscription by id. NOTE: You need to have the view permission of device management to invoke this API.  Rate limits are enforced, and 20 requests per minute are supported per workspace. The API endpoint returns 429 if this threshold is breached.

Endpoint: GET /subscriptions/v1/subscriptions/{id}
Version: latest
Security: Bearer
