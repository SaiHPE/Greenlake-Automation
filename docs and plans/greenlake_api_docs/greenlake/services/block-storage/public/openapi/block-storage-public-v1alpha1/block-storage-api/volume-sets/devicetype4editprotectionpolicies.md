---
title: "PUT /block-storage/v1alpha1/devtype4-storage-systems/{systemId}/applicationsets/{id}/protection-policies"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/block-storage/public/openapi/block-storage-public-v1alpha1/block-storage-api/volume-sets/devicetype4editprotectionpolicies.md"
scraped_at: "2026-06-07T06:14:35.342395+00:00Z"
---
...
Endpoint: PUT /block-storage/v1alpha1/devtype4-storage-systems/{systemId}/applicationsets/{id}/protection-policies
Version: 1.0.0
Security: bearer
...
## Request fields (application/json):
  ...
  - `createSchedules.name` (string, required)
    Name of the Schedule
    Example: "Every_1_hour_on_sunday_monday"

  - `createSchedules.period` (integer, required)
  ...
  - `createSchedules.readOnly` (boolean,null)
  ...
  - `createSchedules.retainSecs` (integer,null)
  ...
  - `createSchedules.untilTime` (integer)
  ...
  - `modifySchedules` (array)

  - `modifySchedules.id` (string, required)
    schedule id
  ...
  - `removeSchedules` (array)

  - `removeSchedules.id` (string, required)
