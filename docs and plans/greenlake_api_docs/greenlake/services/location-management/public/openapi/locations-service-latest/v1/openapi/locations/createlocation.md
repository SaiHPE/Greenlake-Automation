---
title: "POST /locations/v1/locations"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/location-management/public/openapi/locations-service-latest/v1/openapi/locations/createlocation.md"
scraped_at: "2026-06-07T06:15:30.463627+00:00Z"
---
...
Endpoint: POST /locations/v1/locations
Version: v1
Security: Bearer
...
## Request fields (application/json):
  ...
  - `addresses.country` (string, required)
    The location's country.

  - `addresses.postalCode` (string, required)
    The location's postal code.

  - `addresses.state` (string, required)
    The location's state or region.

  - `addresses.streetAddress` (string, required)
