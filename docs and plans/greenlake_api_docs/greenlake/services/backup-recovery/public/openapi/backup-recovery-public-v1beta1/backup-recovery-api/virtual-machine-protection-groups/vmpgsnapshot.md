---
title: "GET /backup-recovery/v1beta1/virtual-machine-protection-groups/{vmpg-id}/snapshots/{snapshot-id}"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/backup-recovery/public/openapi/backup-recovery-public-v1beta1/backup-recovery-api/virtual-machine-protection-groups/vmpgsnapshot.md"
scraped_at: "2026-06-07T06:14:07.231425+00:00Z"
---

# Get details of a virtual machine protection group snapshot.

Get detailed information for a virtual-machine-protection-group snapshot qualified by snapshot-id.

Endpoint: GET /backup-recovery/v1beta1/virtual-machine-protection-groups/{vmpg-id}/snapshots/{snapshot-id}
Version: 1.1.0
Security: bearer
...
created this snapshot or protection policy.
  ...
  - `storageSystemsInfo.type` (string)
    The type of resource.
