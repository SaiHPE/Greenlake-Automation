---
title: "POST /auditlogs/ui/v1/configs"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/audit-logs/public/openapi/audit-logs/v1/audit-trail/ui-auditlogs/createauditlogconfigs.md"
scraped_at: "2026-06-07T06:16:37.935819+00:00Z"
---

# Post external application audit logs specific configurations.

Endpoint: POST /auditlogs/ui/v1/configs
Version: v1
...
## Request fields (application/json):
  ...
  - `app_audit_info` (object)

  - `app_audit_info.app_type` (string)
    Type of an external application.
    Example: "COMPUTE"

  - `app_audit_info.categories` (array)
  ...
  - `app_audit_info.dashboard_columns` (object)

  - `app_audit_info.dashboard_columns.all` (object)
  ...
  - `app_audit_info.dashboard_columns.fixed` (object)
  ...
  - `app_audit_info.dashboard_columns.default` (object)
    Example: {"Category":"category","Time":"audit_created_at","Description":"description"}

  - `app_audit_info.order` (object)
