...
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/audit-logs/public/openapi/audit-logs-latest/v1/audit-trail-fetch.md"
scraped_at: "2026-06-07T05:46:44.703794+00:00Z"
---
...
[HPE GreenLake API for Audit Logs](https://developer.greenlake.hpe.com/_bundle/docs/greenlake/services/audit-logs/public/openapi/audit-logs-latest/@v1/audit-trail-fetch.yaml)

## Audit logs - v1

### Get all audit logs of an application or user.

 - [GET /audit-log/v1/logs](https://developer.greenlake.hpe.com/docs/greenlake/services/audit-logs/public/openapi/audit-logs-latest/v1/audit-trail-fetch/audit-logs-v1/getauditlogs.md): The audit logs can be filtered using a variety of parameters. Queries should be separated by and and can utilize eq, contains, and in operators to construct the final query. Each query should follow the format:
...
### Get additional detail of an audit log.
 ...
 - [GET /audit-log/v1/logs/{id}/detail](https://developer.greenlake.hpe.com/docs/greenlake/services/audit-logs/public/openapi/audit-logs-latest/v1/audit-trail-fetch/audit-logs-v1/getauditlogdetails.md)
