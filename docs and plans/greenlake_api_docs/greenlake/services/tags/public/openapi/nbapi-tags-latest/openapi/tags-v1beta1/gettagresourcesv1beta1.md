---
title: "GET /tags/v1beta1/tag-resources"
source_url: "https://developer.greenlake.hpe.com/docs/greenlake/services/tags/public/openapi/nbapi-tags-latest/openapi/tags-v1beta1/gettagresourcesv1beta1.md"
scraped_at: "2026-06-07T06:16:27.189242+00:00Z"
---
...
Endpoint: GET /tags/v1beta1/tag-resources
Version: v1
Security: Bearer
...
The examples are not an exhaustive list of all possible filtering options.
  ...
  - `filter-tags` (string)
    Filter expressions consisting of simple comparison operations joined by logical operators to be applied on the assigned tags or their values. The comparison operations are case-insensitive. 
| CLASS       | EXAMPLES                                          |
|------------|----------------------------------------------------|
| Types       | string                                            |
| Operations  | eq, ne                                            |
NOTE: Logical operators are not supported. 
